...
public struct HQRuntime {
    
    /// Gets the Obj-C reference for the instance object within the UIView extension.
    /// If nil, initializer object and associated.
    @discardableResult public static func AssociatedObject<T: Any>(base: Any, key: UnsafePointer<UInt8>, initializer: () -> T, policy: objc_AssociationPolicy = .OBJC_ASSOCIATION_RETAIN_NONATOMIC) -> T {
