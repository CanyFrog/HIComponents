...
//    @discardableResult func subscribe(_ events: DownloadClosure ...) -> UInt64
    @discardableResult func subscribe(url: URL, _ events: DownloadClosure ...) -> UInt64
